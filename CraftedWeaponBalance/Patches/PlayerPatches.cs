...
namespace CraftedWeaponBalance.Patches
{
    ...
    internal class PlayerPatches
    {
        ...
        {
            CraftedWeaponBalancePlugin.Log.LogInfo("In Player Awake method Prefix.");
            return true;
        }
        ...
        {
            CraftedWeaponBalancePlugin.Log.LogInfo("In Player Awake method Postfix.");
        }
    }
}