...
namespace CraftedWeaponBalance
{
    ...
    public class CraftedWeaponBalancePlugin : BaseUnityPlugin
    {
        ...
        // e.g.
        // 1.0.0
        private const string MyGUID = "com.Durandal.CraftedWeaponBalance";
        ...
        // e.g.
        // float myFloat = CraftedWeaponBalancePlugin.FloatExample.Value;
        ...
        private void Awake()
        {
            ...
            // .e.g.
            // CraftedWeaponBalancePlugin.Log.LogDebug("Debug Message to BepInEx log file");
            Log = Logger;
        }
        ...
        private void Update()
        {
            if (CraftedWeaponBalancePlugin.KeyboardShortcutExample.Value.IsDown())
            {
